...
import com.paltecno.databaserelationships.service.PlayerProfileService;
import com.paltecno.databaserelationships.service.PlayerService;
...
public class PlayerController {
	...
	public Player assignDetail(@PathVariable int id,@PathVariable int profile_id) {
		...
		return service.assignPrfile(id, profile);
